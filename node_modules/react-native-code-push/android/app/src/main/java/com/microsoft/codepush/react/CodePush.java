    ...
    private boolean isLiveReloadEnabled(ReactInstanceManager instanceManager) {
        ...
        if (instanceManager != null) {
            ...
            if (devSupportManager != null) {
                // DevInternalSettings devInternalSettings = (DevInternalSettings)
        ...
        if (pendingUpdate != null) {
            ...
            try {
                ...
                if (updateIsLoading) {
                    ...
                    CodePushUtils
                            .log("Update did not finish loading the last time, rolling back to a previous version.");
                    ...
                    mSettingsManager.savePendingUpdate(
                            pendingUpdate.getString(CodePushConstants.PENDING_UPDATE_HASH_KEY),
                            /* isLoading */true);
                }
